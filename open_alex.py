...
def search_experts_callback(topic):
    def fetch_and_update():
        ...
        root.after(0, lambda: gui.update_expert_found_stats_label(
...
def display_expert_info_callback(selected_expert_name):
    def fetch_expert_info():
        start_time = time.time()
        root.after(0, lambda: gui.update_expert_info_label("Fetching author information..."))
        root.after(0, lambda: gui.update_author_information_stats_label(
